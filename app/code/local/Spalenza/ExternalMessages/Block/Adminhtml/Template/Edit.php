...
/**
 * Class Spalenza_ExternalMessages_Block_Adminhtml_Template_Edit
 */
class Spalenza_ExternalMessages_Block_Adminhtml_Template_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    /**
     * Spalenza_ExternalMessages_Block_Adminhtml_Template_Edit constructor.
     */
    ...
    public function getHeaderText()
    {
        if (Mage::registry("template_data") && Mage::registry("template_data")->getId()) {
            return Mage::helper("externalmessages")->__("Edit Item '%s'", $this->htmlEscape(Mage::registry("template_data")->getId()));
        } else {
