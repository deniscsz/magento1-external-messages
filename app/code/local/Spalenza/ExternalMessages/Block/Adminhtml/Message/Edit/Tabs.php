...
/**
 * Class Spalenza_ExternalMessages_Block_Adminhtml_Message_Edit_Tabs
 */
class Spalenza_ExternalMessages_Block_Adminhtml_Message_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    /**
     * Spalenza_ExternalMessages_Block_Adminhtml_Message_Edit_Tabs constructor.
     */
    ...
    protected function _beforeToHtml()
    {
        $this->addTab("form_section", array(
            ...
            "content" => $this->getLayout()->createBlock("externalmessages/adminhtml_message_edit_tab_form")->toHtml(),
        ));
